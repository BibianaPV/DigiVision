...
donde   
𝐿loc: mide el error en la predicción de las cajas,   
𝐿conf:  evalúa la presencia del objeto   
𝐿cls: cuantifica el error de clasificación. 
...
<p align="center">
  <img src="./results/YOLOv8n/runs/detect/val2/confusion_matrix.png" width="500" />
  <img src="./results/YOLOv8n/runs/detect/val2/BoxR_curve.png" width="500" />
</p> 
...
| :---- | :---- |
| Bibiana Andrea Peña V. | Redaccion del informe final, análisis exploratorio del dataset, dataset YOLO, Deteccion y seguimiento utilizando YOLOv8n, IoU, Kalman, desplazamiento por flujo óptico, SORT para SoccerNet |
