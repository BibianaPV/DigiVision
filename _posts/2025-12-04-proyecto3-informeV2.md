...
**Normalización espacial**: Todas las imágenes fueron reescaladas a dimensiones fijas de 256×256 píxeles mediante interpolación bilineal. Este paso permitió estandarizar la resolución de entrada, reducir la variabilidad asociada a distintos equipos radiológicos y facilitar la aplicación de descriptores de textura y modelos de clasificación.

**Normalización e intensificación del contraste**:Para mejorar la visibilidad de estructuras anatómicas relevantes y compensar diferencias en iluminación, se aplicó la técnica CLAHE .

**Preparación de estructura de salida**:Se creó una estructura de carpetas espejo que replica la organización del dataset original en sus particiones: train, test y val. Esto permitió almacenar de manera ordenada las imágenes resultantes y garantizar trazabilidad entre los conjuntos original y procesado.

**Generación del dataset preprocesado**:Una vez definido el pipeline, se procesaron de forma secuencial todas las imágenes del dataset. Finalmente, la imagen transformada se guardó en el directorio correspondiente según su categoría y partición.

### 3.1.3 Segmentación
Para la segmentación se utilizaron dos metodologías.

#### 3.1.3.1 Segmentacion por Umbralizacion
...
#### 3.1.3.2 Segmentación automática de los pulmones mediante un modelo PSPNet
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/LBP_clase_normal.png)
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/LBP_clase_neumonia.png)
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/lossCNN.png)
...
<p align="center">
  <img src="/DigiVision/3. Clasificación de Imágenes Médicas/results/imagenes/matrizCNN.png" width="500" />
  <img src="/DigiVision/3. Clasificación de Imágenes Médicas/results/imagenes/ROCCNN.png" width="500" />
</p>
...
### 4.3.4 Clasificador k-Nearest Neighbors (k-NN)
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/comparación_matrix_kNN.png)
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/comparación_AUC_kNN.png)
...
![image1](/DigiVision/3.%20Clasificaci%C3%B3n%20de%20Im%C3%A1genes%20M%C3%A9dicas/results/imagenes/comparación_features_kNN.png)
